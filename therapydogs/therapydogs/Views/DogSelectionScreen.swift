...
struct DogSelectionScreen: View {
    ...
    var dogs: [TherapyDog] = [
        ...
        TherapyDog(dogName: "Radar", dogDescription: "Radar is a Labrador Retriever. He was born on July 23, 2014. Radar’s hobbies include camping, taking long walks and spending time with his family. Radar’s favorite toys are deer antlers and his best friend is Mattis K9 from the Franklin County Sheriff’s Office. Radar’s handler is ReNea.",dogDescriptionShort: "Radar is a Labrador Retriever. He was born on July 23, 2014.", dogImage: UIImage(imageLiteralResourceName: "Radar.png")),
        TherapyDog(dogName: "Rocky", dogDescription: "Rocky is a Boxer. Rocky had a difficult upbringing in an abusive home. He was rescued by Canine Castaways in Indiana and was adopted by his handler, Jeannette, on March 13, 2019. Rocky loves his squeaky balls, running with his mom and snuggling with his sister, Raven. Rocky’s handler is Jeannette", dogDescriptionShort: "Rocky is a Boxer. Rocky had a difficult upbringing in an abusive home.", dogImage: UIImage(imageLiteralResourceName: "Rocky.png")),
    ...
    @State private var selectedDog: TherapyDog?
